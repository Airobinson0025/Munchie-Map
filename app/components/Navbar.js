...
const Navbar = () => {
  return (
    <header className='font-nunito text-lg text-lime-600 tracking-wide flex justify-between items-center p-3 bg-neutral-900 shadow-sm shadow-neutral-100/40 z-1000 fixed w-full'>
